<template>
    <div class="m-portlet__body" id="users">
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="all_tutors" role="tabpanel">
                <list
            ...
            <div class="tab-pane" id="add_edit_tutor" role="tabpanel">
                <div>
                    <create-edit 
                        :props-urls="urls" 
                        :props-trans="trans"
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            $('a[href="#add_edit_user"]').click((event) => {
                if(base.formReset)
        ...
        methods : {
            ...
            resetPanelStatus(value) {
                ...
                if(value == 1 || value == 2) {
                    ...
                    $('a[href="#add_edit_tutor"]').trigger('click');
                    return true;
                }
                
                $('a[href="#all_tutors"]').trigger('click');
                return true;
            }
        }
    }   
