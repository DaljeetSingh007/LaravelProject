    ...
    <div class="animated fadeIn" v-show="createEditPanelStatus">
        <form @submit.prevent="sendForm" autocomplete="off" class='m-form m-form--state'>
            ...
            <div class="row m-t-15">
                <div class="col">
                    <div class="form-group m-form__group" :class="{'has-danger': form.$errors.has('password')}">
                        ...
                        <input type="password" class="form-control m-input form-control-danger" id="password" name="password" v-model="form.$fields.password" autocomplete="off" aria-describedby="password" />
                ...
                <div class="col">
                    <div class="form-group m-form__group" :class="{'has-danger': form.$errors.has('password_confirmation')}">
                        ...
                        <input type="password" class="form-control m-input form-control-danger" id="password_confirmation" name="password_confirmation" v-model="form.$fields.password_confirmation" autocomplete="off" aria-describedby="confirm_password" />
            ...
            <div class="row m-t-15">
                <div class="col-12">
                    <div class="form-group m-form__group">
                        <label for="status" class="col-form-label" v-text="trans.input_roles"></label>
                        <div class="row">
                            <div class="col-2" v-for="role in moduleData.roles">
