                    ...
                    <div class="row">
                        <div class="col-2">
                            <div class="form-group m-form__group">
                                ...
                                <input type="text" id="search_name" @keyup.enter="showMore" class="form-control m-input" v-model="search.name"/>
    ...
    data() {
        ...
        return {
            ...
            fields: [
                ...
                {
                    name: 'end_time',
                    title: () => base.trans.column_heading.end_time,
                    sortField: 'end_time',
                },
                {
                    name: 'estimated_time',
                ...
                {
                    name: '_tutors',
                    title: () => base.trans.column_heading.tutor,
                    callback: 'tutorFormat',
                },
                {
                    name: '_students',
                    title: () => base.trans.column_heading.student,
