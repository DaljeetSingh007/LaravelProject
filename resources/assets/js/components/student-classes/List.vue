            ...
            <vuetable ref="vuetable"
                ...
                pagination-path="">
                    <template slot="actions" slot-scope="props">
                        <a :href="urls.join_class.replaceAt(urls.join_class.length-1,props.rowData.uuid)" :class="['g-join-button','btn btn-primary btn-sm',props.rowData.uuid]" v-show="false">
                            {{trans.common.join}}
                        </a>
