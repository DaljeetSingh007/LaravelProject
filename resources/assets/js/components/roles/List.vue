                    ...
                    <div class="row">
                        <div class="col-2">
                            <div class="form-group m-form__group">
                                <label for="search_name"> {{trans.input_name}}</label>
                                <input id="search_name" type="text" @keyup.enter="showMore" class="form-control m-input" v-model="search.name"/>
            ...
            <vuetable ref="vuetable"
                ...
                pagination-path="">
                    <template slot="actions" slot-scope="props">
                        <button class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" @click="editEvent(props.rowData.uuid)" v-bind:href="permissions.edit == 1" v-show="props.rowData.is_public != 0">
                        ...
                        <delete
                            ...
                            v-show="props.rowData.is_public != 0"
                        >
                        </delete>
                    </template>
            </vuetable>
    ...
    data() {
        ...
        return {
            ...
            fields: [
                ...
                {
                    name: '_m_permissions',
                    title: () => base.trans.column_heading.permissions,
                },
                {
                    name: '__slot:actions',
