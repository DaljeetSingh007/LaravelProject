<template>
    <div class="m-portlet__body" id="users">
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="all_students" role="tabpanel">
                <list
            ...
            <div class="tab-pane" id="add_edit_student" role="tabpanel">
                <div>
                    <create-edit 
                        :props-urls="urls" 
                        :props-trans="trans"
        ...
        methods : {
            ...
            resetPanelStatus(value) {
                ...
                if(value == 1 || value == 2) {
                    ...
                    $('a[href="#add_edit_student"]').trigger('click');
                    return true;
                }
                
                $('a[href="#all_students"]').trigger('click');
                return true;
            }
        }
    }   
